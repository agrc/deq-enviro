...
namespace Deq.Search.Soe {
    ...
    public abstract class SoeBase {
        ...
        /// <summary>
        ///     stops the server object specified by the IServerObjectHelper reference. Cleans up after itself before shutting down
        ///     its parent mapservice etc.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes and starts the server object specified by the IServerObjectHelper reference. If you have business logic
        ///     that you want to run when the SOE first becomes enabled, don’t put it in Init() or in your SOE class’s constructor;
        ///     instead, use the following IObjectConstruct.Construct() method
        /// </summary>
        ...
        /// <summary>
        ///     Allows for REST requests and responses to come into the service. These methods create the schema and handle the
        ///     requests.
        /// </summary>
