require([
    ...
    describe('app/search/RelatedTableGrid', function() {
        ...
        describe('formatData', function () {
            ...
            it('supports addition info field links with existing query parameters', function () {
                var container2 = domConstruct.create('div');
                // config.getRelatedTableByIndex.and.stub();
                config.getRelatedTableByIndex.and.returnValue({
                    fields: [['blah', 'blah']],
                    index: 33,
                ...
                expect(widget2.records[0].attributes.additionalInfo)
                    .toEqual('http://blah.com?prop=value&ID=3&NAME=name&TYPE=type&ADDRESS=address&CITY=city&' +
                        'MAJ_STDESC=COC%20Issued&ACKEY=869');
